...
PROVIDES += "kodi"
RPROVIDES_${PN} += "kodi"
RDEPENDS_${PN} += "gb-v3ddriver-${STB_PLATFORM}"
RDEPENDS_${PN} += "glibc-gconv-iso8859-1"

FILESEXTRAPATHS_prepend := "${THISDIR}/${PN}:"

SRC_URI_append += "http://source.mynonpublic.com/gigablue/v3ddriver/xbmc-support_${STB_PLATFORM}_${GLPR}.tar.gz;name=xbmc-support"
